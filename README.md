...
横断線が堤防まで届いていないケースでは，以下の対応のいずれか，もしくは両方を行って下さい．
...
横断線が（Marginの設定値を超えて）堤内地の遠方まで伸びているケースでは，以下の対応のいずれか，もしくは両方を行って下さい．
...
- DEMをBまたはCに設定し，Use intermediate resultを0に設定する
