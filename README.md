...
このような横断面については，settings.csvのW.S.T.をプラスの値（1など）に設定して下さい．
...
W.S.T.が0の場合は，どちらの推定方法を使うべきかをプログラムが自動的に判定します．

この自動判定が上手く行かないと，水面の区間の幅の過小評価に繋がります．
