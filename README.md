...
上流端のポイントは，抽出したい範囲から1kmほど上流に設定して下さい．これは，河道縦横断データの抽出を行うプログラムが，下流端のポイントから横断面の設定を開始し，上流端のポイントの直前で横断面の設定を終了するためです．そのため，上流端のポイント上には横断面が設定されません．
...
横断線が（Marginの設定値を超えて）堤内地の遠方まで伸びている横断面では，以下の対応のいずれか，もしくは両方を行って下さい．
...
#### 5-3-5. 異なる横断面の横断線が交差する

河道内の計算格子を作成する際に，交差した横断線の存在は邪魔になることがあります．

このプログラムでは，こうした横断線を回転することにより，交差を解消することができます．

横断線を回転する横断面には，以下の対応を行って下さい．
...
#### [石狩川（北海道，河川コード：8101030001）河口部～夕張川合流部](./examples/ishikari-gawa)

#### [石狩川（北海道，河川コード：8101030001）河口部～神居古潭100m間隔](./examples/ishikari-gawa)

#### [九頭竜川（福井県，河川コード：8606070001）河口部～五松橋](./examples/kuzuryu-gawa)

#### [日野川（福井県，河川コード：8606070019）九頭竜川合流部～三尾野](./examples/hino-gawa)

#### [足羽川（福井県，河川コード：8606070022）日野川合流部～天神橋](./examples/asuwa-gawa)
