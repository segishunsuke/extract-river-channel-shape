...
以下の図は，先ほどの例の回転後の様子です．横断面の交差が解消されていることが確認できます．回転された横断面の左岸端・右岸端は不適切な位置にあることがあります．その場合には，[5](./README.md#5)の調整を実行して下さい．

<img src="./assets/images/case5b.png">

横断面の回転機能は，横断面の左岸端・右岸端が適切な位置にあることを前提としています．**[5](./README.md#5)の調整が完了するまでは，Clear Crossingsを0にして横断面抽出を行って下さい**．
