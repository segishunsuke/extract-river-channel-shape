...
22.000kの横断面の右岸側が，明らかに堤防に届いていません．right_bankの標高を確認すると，6.522mとなっています．これは，隣接する横断面のright_bankの標高（10.785m, 10.741m）と比べても，明らかに低いです．
...
この例では，右岸側のtol1が低過ぎることが原因だと考えられたため，22.000kのRight tol1を5m→7.5mに変更しました．
...
なお，人工堤防が存在する区間においては通常，横断面のラインは，左岸線，右岸線の外側に少しはみ出します（はみ出す長さは，basic parameters.csvで設定したMarginを上限とします）．**はみ出しが見られない場合には，横断面が堤防の頂点まで届いていない可能性が高い**ので，パラメータの設定を見直すことを推奨します．
