...
このような場所では，河道と氾濫原の境界が曖昧であり，横断線の範囲設定は裁量的に行えるケースが多いと考えられます．

ただし，川のすぐ横に市街地があるような場所もあり，このような場所においては，適切な箇所で横断線を止める必要があります．

台形型の堤防が存在しない横断面において，横断線を「適切な箇所」で止めるには，以下の対応を行って下さい．

- tol2を0にする：台形型の堤防が存在しない場合にはtol2 = 0が適切な設定です
- tol1を「適切な箇所」よりも少し低い標高に設定する
- tol3を「適切な箇所」よりも少し急な勾配に設定する
