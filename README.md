...
- tol1 [m]: 横断線の範囲設定に利用（後述）
- tol2 [m]: 横断線の範囲設定に利用（後述）
- tol3: 横断線の範囲設定に利用（後述）
- tol4 [m]: 横断線の範囲設定に利用（後述）
- tol5 [m]: 横断線の範囲設定に利用（後述）
- adjust1: 横断線の範囲設定に利用（後述）
- adjust2: 横断線の範囲設定に利用（後述）
- adjust3: 横断線の範囲設定に利用（後述）
