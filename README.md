...
- Plane rectangular coordinate system: 対象の河道をカバーする平面直角座標系のEPSGコード
- Initial point ID: 上流端のポイントの識別番号
- Terminal point ID: 下流端のポイントの識別番号
- Flow [m3/s]: 対象の河道の代表地点の平水流量
- tol1 [m]: 横断線の範囲設定に利用
- tol2 [m]: 横断線の範囲設定に利用
- tol3: 横断線の範囲設定に利用
- tol4 [m]: 横断線の範囲設定に利用
...
対象の河道をカバーする平面直角座標系のEPSGコードについては，以下のURLから調べて下さい．
...
上流端のポイントについては，[3](#3)でも述べたように，抽出したい範囲から1kmほど上流に設定して下さい．
