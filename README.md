...
Use intermediate resultが1の場合，前回の左岸端・右岸端の設定が再利用されます．逆に，左岸端・右岸端の位置修正が不要な横断面については，Use intermediate resultを1のままにして下さい．これにより，前回の左岸端・右岸端の位置が再利用され，抽出に要する時間を短縮できます．
