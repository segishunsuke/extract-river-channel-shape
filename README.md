...
横断線が堤防まで届いていないケースでは，以下のいずれか，もしくは両方を行って下さい．
...
横断線が（Marginの設定値を超えて）堤内地の遠方まで伸びているケースでは，以下のいずれか，もしくは両方を行って下さい．
...
ただし，川のすぐ横が市街地であるような場所もあり，このような場所においては，適切な箇所で横断線を止める必要があります．

台形型の堤防が存在しない横断面において，横断線を「適切な箇所」で止めるには，以下の対応を行って下さい．

- tol2を0にする
- tol1を「適切な箇所」よりも低い標高に設定する
- tol3を「適切な箇所」よりも急な勾配に設定する

#### 5-3-4. DEMから標高が得られない

このプログラムは「DEMに標高が記録されていない地点は水面である」という前提の下に処理を行います．

そのため，「DEMに標高が記録されていない陸上の地点」が横断線上に存在すると，横断面形の設定が適切に行えません．
